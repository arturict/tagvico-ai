...
> **v3 development preview.** The latest published stable release is v2.0.0.
> Do not deploy a `3.0.0` image until that tag appears on the GitHub releases
> page. Companion writes in the v3 preview always require explicit approval.
