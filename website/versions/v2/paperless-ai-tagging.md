...
infrastructure you control. Selecting OpenAI, Anthropic, OpenRouter, Azure, or
...
4. Test 20–50 representative documents and record correctness per field.
5. Move only reliable fields or document types to Automatic mode.
