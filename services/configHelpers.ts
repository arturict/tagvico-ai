...
function buildUiConfig(env: ConfigLike = process.env, version = '') {
  ...
  return {
    ...
    OPENCODE_BASE_URL: env.OPENCODE_BASE_URL || 'https://console.opencode.ai/inference/openai/v1',
...
function normalizeProviderPayload(payload: ConfigLike = {}) {
  ...
  return {
    ...
    opencodeBaseUrl: payload.opencodeBaseUrl || payload.OPENCODE_BASE_URL || 'https://console.opencode.ai/inference/openai/v1',
